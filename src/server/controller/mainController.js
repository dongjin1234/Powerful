...
export const getHome = async (req, res) => {
  ...
  return res.render("main/home", {course});
}
export const getUsed = (req, res) => res.render("main/used");
export const getCourse = async (req, res) => {
  const course = await MainService.getAllCourse();
  const tour = await MainService.getAllTour();
  const food = await MainService.getAllFood();
  const festival = await MainService.getAllFestival();
  return res.render("main/course", { course , tour, food, festival });
};
